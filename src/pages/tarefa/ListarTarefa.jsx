...
const ListarTarefa = () => {
  ...
  const handleClickOpenDialog = (id, descricaoTarefa) => {
    setTaskToDelete({
      id: id,
  ...
  useEffect(() => {
    ...
    setTarefas(
      initialRows.filter(tarefa => {
        return tarefa.descricaoTarefa.toLocaleLowerCase().normalize('NFD').includes(search.toLocaleLowerCase()) ||
        tarefa.tituloTarefa.toLocaleLowerCase().normalize('NFD').includes(search.toLocaleLowerCase())
      }),
    );
  }, [search])
        ...
        <CardContent>
          <TableContainer component={Paper}>
              ...
              <TableBody>
                {tarefas?.map((row, indice) => (
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <Button variant="contained" color="error" onClick={() => handleClickOpenDialog(row.idTarefa, row.descricaoTarefa)}><DeleteIcon fontSize="small" /></Button>
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
            ...
            <Dialog open={openDialog} onClose={handleCloseDialog}>
              ...
              <DialogContent>
                <DialogContentText>
                  Você está prestes a deletar a tarefa: {taskToDelete?.descricao}
                </DialogContentText>
              </DialogContent>
              <DialogActions>
